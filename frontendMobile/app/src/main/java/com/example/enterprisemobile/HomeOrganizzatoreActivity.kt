                    ...
                    if (identificativoStanzaSelezionata == null) {
                        ...
                        Column(modifier = Modifier.fillMaxSize()) {
                            ...
                            SchermataDellaChat(
                                ...
                                seiOrganizzatore = true, // ⬅️ Sbloccato!
                                identificativoUtenteLocale = 1L // ⬅️ SOSTITUISCI QUESTO CON L'ID REALE DAL TUO SESSION MANAGER!
                            )
                        }
                    }
                }
